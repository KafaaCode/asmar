...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <?php if(auth()->check() && $userDiscount && !($userDiscount->amount == 0)): ?>
            <div class="alert alert-success text-center">
                لديك خصم بنسبة <?php echo e($userDiscount->amount); ?>% سيتم تطبيقه تلقائياً.
            </div>
        <?php endif; ?>
...
<script>
    ...
    <script>
        ...
        var discount = <?php echo e($userDiscount ? $userDiscount->amount : 0); ?>;
        ...
        var base_price = parseFloat($('#price_item').val());
        ...
        // تطبيق الخصم
        var discountAmount = (discount > 0) ? (total * (discount / 100)) : 0;
        var total_after_discount = (total - discountAmount).toFixed(10);

        // تحديث واجهة المستخدم
        $('#total').val(total_after_discount);
        $('.total_q').text(total_after_discount + ' ' + currency_code);

        // الحقول المخفية
        $('#base_total').val((qty * base_price).toFixed(10));
        $('#profit_amount').val((total - (qty * base_price)).toFixed(10));
        $('#final_total').val(total_after_discount);
    }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Personal\Freelancer\Asmar Market\asmar\resources\views/front/games/show.blade.php ENDPATH**/ ?>