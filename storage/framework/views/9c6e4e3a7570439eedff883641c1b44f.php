...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mt-4 text-center">
                            ...
                            <div class="input-group mb-3" style="max-width: 500px; margin: 0 auto;">
                                <input type="text" id="apiTokenInput" class="form-control text-center bg-light" value="<?php echo e($user->api_token); ?>" readonly>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Personal\Freelancer\Asmar Market\asmar\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>