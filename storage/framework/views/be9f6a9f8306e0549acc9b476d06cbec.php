                    ...
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                            ...
                            <?php if(auth()->user()->hasPermission('update_users')): ?>
                                <form action="<?php echo e(route('ad.users.resetBalances')); ?>" method="POST" style="display:inline;"
                                    id="withdrawForm">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <th scope="row">
                                                ...
                                                <button class="btn btn-sm <?php echo e($userDiscount ? 'btn-success' : 'btn-info'); ?> mt-2"
                                                    data-bs-toggle="modal" data-bs-target="#discountModal<?php echo e($user->id); ?>">
                                                    <?php echo e($userDiscount ? 'خصم: ' . $userDiscount->amount . '%' : 'إضافة خصم'); ?>

                                                </button>

                                                <div class="modal fade" id="discountModal<?php echo e($user->id); ?>" tabindex="-1"
                                                    aria-labelledby="discountModalLabel<?php echo e($user->id); ?>" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <form
                                                            action="<?php echo e($userDiscount ? route('ad.discounts.update', $userDiscount->id) : route('ad.discounts.store')); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
                                                            <?php if($userDiscount): ?>
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="discountModalLabel<?php echo e($user->id); ?>">
                                                                        <?php echo e($userDiscount ? 'تعديل خصم' : 'إضافة خصم'); ?> للمستخدم:
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="mb-3">
                                                                        <label for="amount<?php echo e($user->id); ?>" class="form-label">نسبة
                                                                            الخصم (%)</label>
                                                                        <input type="number" name="amount"
                                                                            id="amount<?php echo e($user->id); ?>" class="form-control"
                                                                            step="0.01" min="0" required
                                                                            value="<?php echo e($userDiscount ? $userDiscount->amount : ''); ?>">
                                                                    </div>
                                                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Personal\Freelancer\Asmar Market\asmar\resources\views/admin/users/index.blade.php ENDPATH**/ ?>